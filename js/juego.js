...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png', 340, 120, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 180, 230, 15, 30, 1),
    new Obstaculo('imagenes/bache.png', 135, 280, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 70, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 97, 430, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 187, 457, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 259, 450, 30, 30, 1),
    ...
    new Obstaculo('imagenes/bache.png', 720, 115, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 815, 90, 15, 30, 2),
    new Obstaculo('imagenes/valla_horizontal.png', 757, 350, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 855, 390, 15, 30, 1),
    new Obstaculo('imagenes/bache.png', 815, 425, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 461, 262, 30, 15, 1),
    new Obstaculo('imagenes/valla_vertical.png', 241, 382, 30, 30, 1)
  ],
  ...
  enemigos: [
    new ZombieCaminante("imagenes/zombie1.png", 20, 280, 10, 10, 4, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}, 0),
    new ZombieCaminante("imagenes/zombie2.png", 20, 400, 10, 10, 6, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}, 0),
    new ZombieCaminante("imagenes/zombie3.png", 280, 90, 10, 10,3, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}, 0),
    new ZombieCaminante("imagenes/zombie4.png", 280, 230, 10, 10, 2, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}, 0),
    new ZombieCaminante("imagenes/zombie1.png", 465, 370, 10, 10, 3, {desdeX: 20, hastaX: 941, desdeY: 20, hastaY: 557}, 0),
    new ZombieConductor("imagenes/tren_horizontal.png", 400, 322, 90, 30, 7, {desdeX: 0, hastaX: 961, desdeY: 292, hastaY: 352}, "h"),
    new ZombieConductor("imagenes/tren_vertical.png", 644, 0, 30, 90, 9, {desdeX: 614, hastaX: 674, desdeY: 0, hastaY: 577}, "v"),
...
Juego.capturarMovimiento = function(tecla) {
  ...
  Juego.dibujar = function() {
    if (Juego.estadoActual == Estado.JUGANDO) {
      ...
      Dibujante.dibujarRectangulo('red', 760, 550, 126, 8);
    }
    else {
      // Borrar el fotograma actual
      Dibujante.borrarAreaDeJuego();
